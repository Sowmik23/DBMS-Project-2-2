...
/*15. It returns the room number and total empty seat in this room number. By this a house tutor can easily find where seat is empty.*/
...
/*16. By this we can know the total number of students of each home town in the hall. */
...
/*17. By this we can know the total number of students of each department in the hall.. */
...
/*18.We can know In which departments students is max in this hall. */
...
/*19. We can know In which home towns students is max in this hall.. */
...
/*20. Which students stay in the single room. */
...
/*21. How many canteen has in each building. */
...
/*22. Every buildings canteen details. */
...
/*23.Determine the building name which has no tv room. */
...
/*24.Search If a departments house tutor exits or not. */

select *
from teacher
where dept_name='Bangla';

/*25.Can easily search if a building has any spot room or not. */

select *
from building
where spot_room not like 'No';

/*26.we can know any mess monthly fee. */
...
/*27.we can know the building name of a teacher by id. */
...
/*28.we can know a computer lab open time and close time  by computer lab name. */
...
/*29.we can search a building if there exits a canteen then we can know if there exits tv_room and spot_room. */
...
/*30.we can know all the information about the director by knowing directortype. */
...
/***********************************<---Insertion/Updation/Delection--->*****************************************/

/*##) update table system */

update canteen
set close_time = '10:30pm'
where name='Sankar Canteen'
...
insert into student values('201','Sowmik Sarker','CSE','2016-17','2nd','10017','C','2','sowmik.cse@gmail.com','12-sept.','Dinajpur');
