...
create table director(
      ...
      directorType varchar(20) not null,

      primary key(directorType)
);
...
create table computer_lab(
      ...
      primary key(name),
      foreign key (building_name) references building(building_name),
      foreign key(directorType) references director(directorType)
);
